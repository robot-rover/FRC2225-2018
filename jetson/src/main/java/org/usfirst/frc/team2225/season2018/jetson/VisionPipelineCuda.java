 ...
 */
public class VisionPipelineCuda
{
    /**
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        String ptxFileName = preparePtxFile("jetson/src/main/cuda/JCudaSampleKernel.cu");
        preparePtxFile("jetson/src/main/cuda/combinedInit.cu");
