...
public class OmniDrive extends Command {
    ...
    protected void execute() {
        ...
        float rotate = (RoboRIOMain.driverInput.getJoy().getBumper(GenericHID.Hand.kLeft) ? 0.3f : 0) + (RoboRIOMain.driverInput.getJoy().getBumper(GenericHID.Hand.kRight) ? -0.3f : 0);
        RoboRIOMain.drivetrain.omniDrive(translate, rotate);
    }
